                ...
                <div id="MediaCenter01">
                            ...
                            <div className="SelectBox">
                                ...
                                <div className="list animated03s fadeIn" style={{display:this.state.SelectBoxOpen01 ? '' : 'none'}}>
                                    <ul>
                                        ...
                                        <li onClick={(e)=>{e.stopPropagation();e.preventDefault();this.handleSelectBoxClose();this.handleSelectValue('select01','TVCF');}}>TVCF</li>
                                        <li onClick={(e)=>{e.stopPropagation();e.preventDefault();this.handleSelectBoxClose();this.handleSelectValue('select01','지면광고');}}>지면광고</li>
                                    </ul>
                                </div>
                    ...
                    <div className="conBox">
                        ...
                        <div className="conTopbox h-box">
                            ...
                            <div className="h-box">
                                <button className="btn" onClick={()=>{this.props.handleGnbMenu('media','4')}}>등록</button>
                            </div>
                        </div>
