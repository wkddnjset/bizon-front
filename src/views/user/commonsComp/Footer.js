                        ...
                        <div className="footerMidIn h-box">
                            <div className="linkBox h-box">
                                <Link to={MenuUrl.TERM_T001} onClick={() => { this.props.handleGnbMenu('terms', '1'); }}>
                                    <div className="text01" title="개인정보처리방침">개인정보처리방침</div>
                                </Link>

                                <Link to={MenuUrl.TERM_T002} onClick={() => { this.props.handleGnbMenu('terms', '2'); }}>
                                    <div className="text02" title="이용약관">이용약관</div>
                                </Link>
                                <Link to={MenuUrl.TERM_T003} onClick={() => { this.props.handleGnbMenu('terms', '3'); }}>
                                    <div className="text02" title="마케팅 수신동의">마케팅 수신동의</div>
                                </Link>
                            </div>
